...
description: Implements one AetherMind build phase end-to-end from the plan file, enforces the three hard invariants, and runs backend/frontend tests. Use proactively when executing any plan phase from bootstrap through tests.
---
