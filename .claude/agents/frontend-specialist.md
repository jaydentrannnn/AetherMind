...
description: Specialist for AetherMind Phase 8 — Next.js 15 App Router, SSE client for /research/{id}/stream, shadcn/ui components, react-markdown report renderer, CitationPopover, VersionDiff with diff-match-patch, and FeedbackForm. Use for any work in frontend/.
model: sonnet
