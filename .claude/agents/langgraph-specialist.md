...
description: Specialist for AetherMind Phase 5 — LangGraph StateGraph, parallel researcher fan-out via Send API, SqliteSaver checkpointer, asyncio.gather tool calls, and the critic conditional edge. Use for any work in backend/app/agent/.
model: sonnet
