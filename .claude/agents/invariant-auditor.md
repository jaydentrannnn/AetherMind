...
description: Read-only scanner that checks the AetherMind codebase for violations of the three hard invariants — router authority, embedding isolation, and citation closure. Run after any significant backend change or when the PreToolUse hook is triggered.
model: haiku
